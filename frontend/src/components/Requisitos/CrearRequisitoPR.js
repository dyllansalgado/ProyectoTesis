...
class CrearRequisitoPR extends Component { 
    constructor(props) {
        super(props);
        this.state = {
            pregunta: [],
    ...
    return(
     <div>
        ...
        <Container fluid className="ContenedorRespuesta">
          <Modal.Dialog>
            <div> 
            <h3 className="text-center"> Bienvenido: {usuario.nombre_usuario}</h3>
            </div>
            <Modal.Body>
            <h5 className="text-center">Creando un requisito para Pregunta o Respuesta</h5>
              <form>
...
export default CrearRequisitoPR;